      ...
      <div className="w-full grid grid-cols-2 gap-2 mb-4">
        <div className={`p-3 rounded-2xl border-2 transition-all ${isMyTurn ? 'bg-[#967bb6]/10 border-[#967bb6] shadow-[0_0_20px_rgba(150,123,182,0.2)]' : 'bg-white/5 border-white/10'}`}>
          <div className="flex items-center space-x-2 mb-1">
            <img src={me?.avatar || APP_LOGO_URL} referrerPolicy="no-referrer" className="w-8 h-8 rounded-full border border-white/20" alt="Me" onError={(e) => { (e.target as HTMLImageElement).src = APP_LOGO_URL; }} />
        ...
        <div className={`p-4 rounded-3xl border-2 transition-all ${!isMyTurn ? 'bg-[#967bb6]/10 border-[#967bb6] shadow-[0_0_20px_rgba(150,123,182,0.2)]' : 'bg-white/5 border-white/10'}`}>
          <div className="flex items-center space-x-2 mb-1">
            <img src={opponent?.avatar || APP_LOGO_URL} referrerPolicy="no-referrer" className="w-7 h-7 rounded-full border border-white/20" alt="Opponent" onError={(e) => { (e.target as HTMLImageElement).src = APP_LOGO_URL; }} />
